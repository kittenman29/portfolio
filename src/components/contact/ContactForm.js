...
const Contact = () => {
  ...
  const formSubmit = e => {
    ...
    axios
      .post("https://will-schulz-portfolio-back-end.herokuapp.com/api/v1", data)
      .then(res => {
        resetForm();
        alertSuccess();
        setWaiting(false);
      ...
      <div>
        <form className="contact-form" onSubmit={formSubmit}>
          <div className="name-input-container input-container">
            <label className="name-label label" htmlFor="message-name">
              Your Name:
            </label>
            <input
          ...
          <div className="email-input-container input-container">
            <label className="email-label label" htmlFor="message-email">
              Your Email:
            </label>
            <input
          ...
          <div className="message-input-container input-container">
            <label className="message-label label" htmlFor="message-input">
              Your Message:
            </label>
            <textarea
